...
.bm-hero-logo{width:clamp(240px,38vw,440px);height:auto;margin-bottom:1rem;filter:brightness(0) saturate(100%) invert(78%) sepia(38%) saturate(548%) hue-rotate(8deg) brightness(95%) contrast(88%);position:relative;z-index:1;}
...
.bm-card{background:#fff;border:1px solid var(--bm-ivory3);border-radius:3px;padding:1.5rem;overflow:hidden;}
.bm-card-img{display:block;width:calc(100% + 3rem);margin:-1.5rem -1.5rem 1.2rem;height:160px;object-fit:cover;}
